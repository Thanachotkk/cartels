 ...
 * [ProfileMobileNumberFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ProfileMobileNumberFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class ProfileMobileNumberFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProfileMobileNumberFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ProfileMobileNumberFragment().apply {
